...
CREATE TABLE IF NOT EXISTS usuario (id integer PRIMARY KEY ASC,user text,pase text,propietario text,sucursal text,estado text,admin text, tipo text);
insert into usuario (user,pase,propietario,sucursal,estado,admin, tipo) values("regdom","UlJleTIwMjE=","ADMIN","Sucursal 00","1","A", "A");
